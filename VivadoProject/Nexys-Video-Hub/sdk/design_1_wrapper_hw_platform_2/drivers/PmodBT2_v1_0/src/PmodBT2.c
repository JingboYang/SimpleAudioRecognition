...
**      Uart_Baud:      The default baud rate to use for the PmodBT2's UART connection
**
**  Return Value:
**      none
**
...
void BT2_Begin(PmodBT2* InstancePtr, u32 GPIO_Address, u32 UART_Address, u32 AXI_ClockFreq, u32 Uart_Baud)
{
    ...
    Xil_Out32(InstancePtr->GpioBaseAddr+4, 0b01);
    Xil_Out32(InstancePtr->GpioBaseAddr,   0b00); // set CTS to 0
